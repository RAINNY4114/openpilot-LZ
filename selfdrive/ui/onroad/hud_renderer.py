...
class HudRenderer(Widget):
  ...
  def _render(self, rect: rl.Rectangle) -> None:
    ...
    exp_button_y = set_speed_y + (UI_CONFIG.set_speed_height - UI_CONFIG.button_size) / 2
    ...
    max_box_x = left_exp_display_x + exp_display_size + UI_CONFIG.border_size

    if self.is_cruise_available:
      self._draw_set_speed(rect, x_override=max_box_x, anchor_x=max_box_x, anchor_y=set_speed_y)
